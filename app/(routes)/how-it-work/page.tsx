...
import { Search, Calendar, UserCheck, Wrench, CheckCircle, Clock, Shield, CreditCard } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50" dir="rtl">
            ...
            <div className="bg-primary text-white py-20">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6">كيف يعمل صنايعي؟</h1>
                    <p className="text-xl max-w-3xl mx-auto mb-8">عملية بسيطة وسهلة للحصول على الخدمة التي تحتاجها</p>
            ...
            <div className="bg-white py-16">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center mb-12">لماذا تختار صنايعي؟</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="py-16 text-center">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-xl text-gray-600 mb-8">احصل على الخدمة التي تحتاجها الآن</p>
