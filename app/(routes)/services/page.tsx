...
import { Bolt, Droplet, Hammer, Paintbrush, Wrench, Brush, Search } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50" dir="rtl">
            ...
            <div className="bg-primary text-white py-20">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl max-w-3xl mx-auto mb-8">اختر من مجموعة واسعة من الخدمات المنزلية المتخصصة</p>
                                    ...
                                    {filteredServices(category.id).map(service => (
                                        <Card key={service.id} className="p-6">
                                            ...
                                            <div className="flex justify-end items-center mb-4">
                                                <span className="text-gray-600">المدة: {service.duration} ساعة</span>
                                            </div>
                                            <Button asChild className="w-full">
                                                <Link href={`/request?category=${category.id}&service=${service.id}&name=${service.name}&duration=${service.duration}`}>احجز الآن</Link>
                                            </Button>
                                        </Card>
                                    ))}
                                </div>
