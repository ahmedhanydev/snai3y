...
export const RegisterForm = () => {
  ...
  //   setValueFn: (name: string, value: string) => void,
  // ) => {
  ...
  const handleChange: UploadProps["onChange"] = ({ fileList: newFileList }) => {
    ...
    if (newFileList.length > 0 && newFileList[0].originFileObj) {
      getBase64(newFileList[0].originFileObj as FileType).then(
        (base64String) => {
          ...
          >
            ...
            <div>
              ...
              <Input
                id="phoneNumber"
                type="tel"
                {...registerCustomerForm("phoneNumber")}
                placeholder="اكتب رقم موبيلك"
                className="w-full"
              />
              <p className="text-red-500">
                {customerErrors.phoneNumber?.message}
              </p>
            </div>
            ...
            <div>
              <label htmlFor="bsd" className="block text-sm font-medium mb-2">
                تاريخ الميلاد
              </label>
              <Input
                id="bsd"
                type="date"
                {...registerCustomerForm("bsd")}
                className="w-full"
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  id="buildingNumber"
                  type="text"
                  {...registerCustomerForm("buildingNumber")}
                  placeholder="رقم المبنى"
                  className="w-full"
                />
                <p className="text-red-500">
                  {customerErrors.buildingNumber?.message}
                </p>
              </div>
              ...
              <div>
                ...
                <Input
                  id="apartmentNumber"
                  type="text"
                  {...registerCustomerForm("apartmentNumber")}
                  placeholder="رقم الشقة"
                  className="w-full"
                />
                <p className="text-red-500">
                  {customerErrors.apartmentNumber?.message}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  id="postalCode"
                  type="text"
                  {...registerCustomerForm("postalCode")}
                  placeholder="الرمز البريدي"
                  className="w-full"
                />
                <p className="text-red-500">
                  {customerErrors.postalCode?.message}
                </p>
              </div>
            </div>
        ...
        <TabsContent value="technician">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label
                  htmlFor="buildingNumberTech"
                  className="block text-sm font-medium mb-2"
                >
                  رقم المبنى
                </label>
                <Input
                  id="buildingNumberTech"
                  type="text"
                  {...registerTechForm("buildingNumber")}
                  placeholder="رقم المبنى"
                  className="w-full"
                />
                <p className="text-red-500">
                  {techErrors.buildingNumber?.message}
                </p>
              </div>

              <div>
                <label
                  htmlFor="apartmentNumberTech"
                  className="block text-sm font-medium mb-2"
                >
                  رقم الشقة
                </label>
                <Input
                  id="apartmentNumberTech"
                  type="text"
                  {...registerTechForm("apartmentNumber")}
                  placeholder="رقم الشقة"
                  className="w-full"
                />
                <p className="text-red-500">
                  {techErrors.apartmentNumber?.message}
                </p>
              </div>
            </div>
